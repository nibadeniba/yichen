		...
		<div class="content">
			...
			<form name="" action="/admin/login" method="post">
				<fieldset>
					...
					<div class="input">
						<input class="input_all password" name="pwd" id="password" type="password" placeholder="密码" onFocus="this.className='input_all password_now';" onBlur="this.className='input_all password'" maxLength="24" />
					</div>
					<!-- <div class="checkbox">
