...
<div class="row page-head">
	<div class="form-horizontal" id="talent">
		<div class="control-group">
			<label class="control-label order_num" style="font-size: 20px;">编辑岗位</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="talent_name" value="{{$talent->talent_name}}" style="width: 640px;" placeholder="请填写岗位名称">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="button" class="talent_add btn btn-primary" value="保存岗位  ">
			</div>
		</div>
	</div>
</div>
