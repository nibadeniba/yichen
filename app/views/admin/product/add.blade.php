...
<div class="row page-head">
	<div class="form-horizontal" id="news">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="title" style="width: 640px;" placeholder="填写产品名">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls img_box">
				<img src="/web/wu.jpg" width="160" class="img-none">
			</div>
		</div>
		<!-- 富文本编辑 -->
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="button" class="add btn btn-primary" value="添加产品">
			</div>
		</div>
...
<script type="text/javascript">
	...
	$('.add').click(function () {
		...
		LayerShow('');
		$.post('/admin/productAdd', data, function (data) {
			LayerHide();
			if (data.code == 1) {
