...
<div class="row page-head">
	<div class="form-horizontal" id="customer">
		<div class="control-group">
			<label class="control-label order_num" style="font-size: 20px;">添加客户</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="customer_name" value="" style="width: 640px;" placeholder="请填写客户名称">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="customer_type">
					<option  value="1">地产企业</option>
					<option  value="2">酒店管理公司</option>
					<option  value="3">设计公司</option>
				</select>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="button" class="customer_add btn btn-primary" value="添加客户">
			</div>
		</div>
